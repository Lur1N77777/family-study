import{a as v,s as c,d as p,i as s,t as $,b as S,A as k,c as w}from"./index-8knsp9ot.js";import{t as n}from"./notification-DFOYBy0U.js";import{e as y}from"./escape-lW1fV86Q.js";async function R(t){t.innerHTML='<div style="padding:var(--space-8);text-align:center;color:var(--color-text-tertiary)">加载中...</div>',await v.refreshUser();const o=v.requireUser(),a=v.getFamilyCode(),i=document.documentElement.getAttribute("data-theme")==="dark",d=await c.getFamilyChildren(a);q(t,o,a,d,i)}function q(t,o,a,i,d){t.innerHTML=`
