import{a as v,s as m,i as g,b}from"./index-8knsp9ot.js";import{t as y}from"./notification-DFOYBy0U.js";import{s as h,h as x}from"./animations-BN6acAuJ.js";import{e as $,r as w}from"./segmented-control-BsrRqP-b.js";async function j(e){e.innerHTML='<div style="padding:var(--space-8);text-align:center;color:var(--color-text-tertiary)">加载中...</div>',await v.refreshUser();const i=v.requireUser(),l=await m.getProducts();let o="all",p=!1;function d(){const t=i.points||0,c=o==="all"?l:l.filter(a=>a.category===o);e.innerHTML=`
