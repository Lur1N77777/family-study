import{a as o,s as c,i as l,b as f}from"./index-8knsp9ot.js";import{a as r,s as u}from"./animations-BN6acAuJ.js";import{t as g}from"./notification-DFOYBy0U.js";import{e as n}from"./escape-lW1fV86Q.js";async function w(e){e.innerHTML='<div style="padding:var(--space-8);text-align:center;color:var(--color-text-tertiary)">加载中...</div>',await o.refreshUser();const a=o.requireUser(),i=o.getFamilyCode(),[s,d,v]=await Promise.all([c.getStats(),c.getFamilyUsers(),c.getActivityLog(10)]),p=d.filter(t=>t.role==="child"),m=d.filter(t=>t.role==="parent"&&t.id!==a.id);e.innerHTML=`
